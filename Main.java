...
public class Main {
    ...
    public static void main(String[] args) {
      ...
      */
        ...
        routes1.add(b);
        routes1.add(c);
        System.out.println("Output#1   " + graph.calculateTotalTimeForRoute(routes1));

        //2. Distance of route A-D
        ArrayList<Town> routes2 = new ArrayList<Town>();
        routes2.add(a);
        routes2.add(d);
        System.out.println("Output#2   " + graph.calculateTotalTimeForRoute(routes2));
        ...
        routes3.add(d);
        routes3.add(c);
        System.out.println("Output#3   " + graph.calculateTotalTimeForRoute(routes3));
        ...
        System.out.println("Output#4   " + graph.calculateTotalTimeForRoute(routes4));
        ...
        System.out.println("Output#6  " + graph.numberOfStopsBetweenTowns(c,c,2));

        //7. Number of trips starting at A,ending at C with 4 stops max
        System.out.println("Output#7  " + graph.numberOfStopsBetweenTowns(a,c,3));
